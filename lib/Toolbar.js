...
var _LinkInput = require("./components/LinkInput");
...
var _ToolbarStyles = require("./styles/ToolbarStyles");
...
exports.default = (0, _radium2.default)(_class = function (_Component) {
  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      var style = [_ToolbarStyles2.default.base];

      var listStyle = [_ToolbarStyles2.default.list, this.state.editingLink && { display: "none" }];

      var wrapperStyle = [_ToolbarStyles2.default.wrapper, !this.state.show && { display: "none" }, this.state.position];

      return _react2.default.createElement(
        "div",
        { style: wrapperStyle, ref: "toolbarWrapper" },
        _react2.default.createElement(
          "div",
          { style: style, ref: "toolbar" },
          _react2.default.createElement(
            "ul",
            { style: listStyle, onMouseDown: function onMouseDown(x) {
                x.preventDefault();
              } },
          ...
          _react2.default.createElement("span", { style: _ToolbarStyles2.default.arrow })
        )
      );
    }
  }]);
